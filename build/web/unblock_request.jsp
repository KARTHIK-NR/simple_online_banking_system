...
<html>
    ...
    <div class="row justify-content-md-center">
        ...
        <div class="col-md-11" id="mainscreen" style="background-color:white;margin-top: 1%;">
            <h2 style="margin-left: 35%"> Unblock Users </h2>
        ...
        <%
            ...
            while(rs.next()){
                   ...
                   out.println("<form action='unblock_user_db.jsp'>");
                   
//                   out.println("<td><button type='info' name='btn' value='"+rs.getString("account_no")+"'>Unblock</button></td></form></tr>");
           out.println("<td><button type='info' style='background-color:green;color:white;padding:8px;margin-left:10%;border-radius:5px;' name='btn' value='"+rs.getString("account_no")+"'>UnBlock</button></td></form></tr>");
