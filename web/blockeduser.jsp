...
<div class="row justify-content-md-center" id="balancerow">
    <div class="col-md-8 justify-content-md-center" id="balance">
        <%
            ...
            out.println("<h2 class='headlines'>Your Account is Blocked</h2>");
            out.println("<h4 class='headlines'>Request to Unblocked</h4>");
             out.println("<form method='post' action='block_db.jsp'>" );
            
             out.println("<input type='submit' name='block' style='background-color:green;color:white;padding:8px;margin-left:15%;border-radius:5px;' value='Request for Unblock'><br></form>");
             }
             else{
                 out.println("<h4 class='headlines'>Unblock Request is Pending</h4>");
             }
